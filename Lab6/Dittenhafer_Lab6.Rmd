...
-   Answer the following two questions using the `inference` function. As 
    ...
    ***In 2005, the 95% confidence interval of U.S. atheism is 0.0038 - 0.0161. In 2012, it is 0.0364 - 0.0634. In this case, there is no overlap, and I conclude that this is convincing evidence that the Unites States saw a change in its atheism index between 2005 and 2012.***
