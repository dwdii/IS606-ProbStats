...
[Docs for interferce function](http://www.openintro.org/stat/slides/inference.R)
...
***Does the number of average visists to the doctor differ between married and unmarried moms? ***
...
***Given the p-value=0, I reject the null hypothesis and conclude that the average number of visits to the doctor is different between married and non-married moms.***
