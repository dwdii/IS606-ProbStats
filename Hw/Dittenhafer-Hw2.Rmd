...
df44 <- data.frame(income, total)
df44
```

#### a. Describe the distribution of total personal income.

Ploting the points below, the visualization shows a concept of the distribution. The distribution is
bimodel and somewhat skewed to left.

```{r, echo=FALSE}
g44 <- ggplot(data=df44) + 
  geom_point(aes(x=income, y=total)) + 
  myTheme + 
