...
Our hypotheses for an analysis of variance (ANOVA) test as to whether the means for each education level are the same or different are as follows:
...
aov_ed_sci <- aov(KeyQuestion ~ HighestEducation, data=WVS_US_06_pos)
aov_ed_sci_summary <- summary(aov_ed_sci)
aov_ed_sci_summary

aovPval06 <- aov_ed_sci_summary[[1]]$'Pr(>F)'[1]
aovFstat06 <- aov_ed_sci_summary[[1]]$'F value'[1]
```
